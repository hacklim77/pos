          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <button class="btn btn-flat btn-sm btn-success" id="tambahBarang" onclick="location.href='<?= base_url('admin/admin/tambahadm') ?>'"><i class="fa fa-plus-square"></i> Tambah Admin</button>
              </div>
              <div class="card-body">
